...
public class Ejercicio1 {
    ...
    static public boolean sorpresaV3(int[] arreglo, int n) {
        ...
        //Sorteo los n que quiero, va a ser nlogn porque el sort es NlogN
        //Es NlogN porque para el caso de enteros utiliza un QuickSort.
        //En el parcial hacerlo con el QuickSort nuestro, ahora fiaca.
        Arrays.sort(arreglo, 0, n);

        //Recorro buscando algún repetido. Esto tiene complejidad n
        for(int i = 1; i <= n; i++){
        ...
        return true;
        //El algoritmo queda nlogn + n + 1, por lo que es complejidad
        //nlogn
        //La complejidad espacial es O(1) porque solo se crea una variable que
        //no depende del largo del arreglo.
    }
